...
# Myao,08.11.2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #

# Data ---------------------------------------------------------------------- #
# Declare variables and constants
strFileName = "C:\_PythonClass\Module 06\ToDoList.txt"  # The name of the data file
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        delete_task = input("What task do you want me to remove?: ")
        for dicRow in list_of_rows:
            if dicRow["Task"] == delete_task:
                list_of_rows.remove(dicRow)
                print("\nOkay, I removed", delete_task)
            else:
                print(delete_task, "doesn't exist in the list.")
        return list_of_rows, 'Success'
...
class IO:
    ...
    def input_task_to_remove():
        Processor.remove_data_from_list(dicRow, list_of_rows)
        return dicRow # return task
